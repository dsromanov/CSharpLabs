...
namespace lab4csharp
{
    public partial class Main : Form
    {
        ...
        {   
            models = Assembly.Load("NewFigureModel");
            types = models.GetTypes().Where(type => type.GetInterface("Figure") != null && !type.IsAbstract);
        ...
        {
            if (method.GetParameters()[0].ParameterType.Name == "Figure")
